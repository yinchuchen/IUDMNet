...
import model.new_model.Loss_all as Loss

from .base.feature import extract_feat_vgg, extract_feat_res
from .base.correlation import Correlation

from .learner_iudm import HPNLearner
...
class iudm(nn.Module):
    def __init__(self, backbone, use_original_imgsize):
        ...
        self.dlc_Loss = Loss.DiceLossCe(2).to(device)
    ...
    def forward(self, query_img, support_img, support_mask):
        ...
        logit_mask = self.hpn_learner(corr,support_mask)
    ...
    def compute_objective(self, logit_mask, gt_mask):
        ...
        return self.dlc_Loss(logit_mask, gt_mask.long())
